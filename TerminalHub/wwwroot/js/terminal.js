...
window.terminalFunctions = {
    ...
    createMultiSessionTerminal: function(terminalId, sessionId, dotNetRef, fontSize) {
        ...
        if (element) {
            ...
            // Unicode11 + VS16 拡幅プロバイダをロード（ブロック文字の幅計算を改善）。
            ...
            // エミュレータ側（TerminalHub.Terminal の VtParser.ApplyVs16 経路）と同一規則。
            ...
            if (typeof Unicode11Addon !== 'undefined' && Unicode11Addon.Unicode11Addon) {
                try {
                    ...
                    console.log('[Unicode11] Unicode11(+VS16) provider loaded successfully');
                } catch (error) {
