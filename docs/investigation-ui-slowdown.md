...
| 放っておくと回復する | **3分経つとゾンビが破棄され購読が減る**（← 決め手） |
...
| 観測 | 意味 |
|---|---|
| 生存Circuit数が開いてるタブ数と一致（通常1） | 正常。ゾンビ累積なし → 別筋を疑う |
| 遅い時に 2, 3, 4... と増えている | **ビンゴ**。破棄されない古いCircuitが積んでいる＝多重発火が原因確定 |
| その後 数分後に数が減った | 3分保持→破棄で回復しているのが `tag` 突き合わせで見える |
